...
BOT_TOKEN = environ.get('BOT_TOKEN', '8464947136:AAE6K5HAykF0CrV5QXrHPzq_aYwudUS590w')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003812984827').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('5361557359', '').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://cinemalokhamtg_db_user:<db_password>@cinemalokham0.8vyoaxk.mongodb.net/?appName=Cinemalokham0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cinemalokham0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'abitfiles')

# File Channel Settings
FILE_CHANNELS = [int(ch) for ch in environ.get('FILE_CHANNELS', '-1003778556292').split()]
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003836488317'))
